            ...
            templates: [
              // 1. HERO BLOK
              {
                ...
                fields: [
                  ...
                  { type: "number", name: "fontSize", label: "Velikost p\xEDsma (px)", description: "V\xFDchoz\xED je 60px", defaultValue: 60 },
                  { type: "string", name: "fontWeight", label: "Tlou\u0161\u0165ka p\xEDsma", options: [{ value: "400", label: "Norm\xE1ln\xED" }, { value: "700", label: "Tu\u010Dn\xE9" }, { value: "900", label: "Extra tu\u010Dn\xE9" }], defaultValue: "900" },
              ...
              // 2. HEADING BLOK
              {
                ...
                fields: [
                  ...
                  { type: "number", name: "fontSize", label: "Velikost p\xEDsma (px)", description: "V\xFDchoz\xED je 36px", defaultValue: 36 },
                  { type: "string", name: "fontWeight", label: "Tlou\u0161\u0165ka p\xEDsma", options: [{ value: "400", label: "Norm\xE1ln\xED" }, { value: "700", label: "Tu\u010Dn\xE9" }, { value: "900", label: "Extra tu\u010Dn\xE9" }], defaultValue: "700" },
                  { type: "number", name: "pt", label: "Vnit\u0159n\xED horn\xED prostor (Padding Top)" },
                  { type: "number", name: "pb", label: "Vnit\u0159n\xED doln\xED prostor (Padding Bottom)" },
                  { type: "number", name: "pl", label: "Vnit\u0159n\xED lev\xFD prostor (Padding Left)" },
                  { type: "number", name: "pr", label: "Vnit\u0159n\xED prav\xFD prostor (Padding Right)" },
              ...
              // 3. CONTENT BLOK
              {
                ...
                fields: [
                  ...
                  { type: "string", name: "align", label: "Zarovn\xE1n\xED obsahu a textu", options: [{ value: "left", label: "Vlevo" }, { value: "center", label: "St\u0159ed" }, { value: "right", label: "Vpravo" }, { value: "custom", label: "Vlastn\xED" }] },
                  { type: "string", name: "textColor", label: "Barva textu", ui: { component: "color" } },
                  { type: "number", name: "fontSize", label: "Velikost p\xEDsma (px)", description: "V\xFDchoz\xED je 18px", defaultValue: 18 },
                  { type: "string", name: "fontWeight", label: "Tlou\u0161\u0165ka p\xEDsma", options: [{ value: "400", label: "Norm\xE1ln\xED" }, { value: "700", label: "Tu\u010Dn\xE9" }], defaultValue: "400" },
                  { type: "number", name: "pt", label: "Vnit\u0159n\xED horn\xED prostor (Padding Top)" },
                  { type: "number", name: "pb", label: "Vnit\u0159n\xED doln\xED prostor (Padding Bottom)" },
                  { type: "number", name: "pl", label: "Vnit\u0159n\xED lev\xFD prostor (Padding Left)" },
                  { type: "number", name: "pr", label: "Vnit\u0159n\xED prav\xFD prostor (Padding Right)" },
              ...
              // 4. CTA TLAČÍTKO
              {
                ...
                fields: [
                  ...
                  { type: "number", name: "fontSize", label: "Velikost p\xEDsma textu (px)", description: "V\xFDchoz\xED je 16px", defaultValue: 16 },
                  { type: "string", name: "fontWeight", label: "Tlou\u0161\u0165ka p\xEDsma tla\u010D\xEDtka", options: [{ value: "400", label: "Norm\xE1ln\xED" }, { value: "700", label: "Tu\u010Dn\xE9" }], defaultValue: "700" },
                  { type: "number", name: "pt", label: "Vnit\u0159n\xED horn\xED prostor (Padding Top) tla\u010D\xEDtka", defaultValue: 14 },
                  { type: "number", name: "pb", label: "Vnit\u0159n\xED doln\xED prostor (Padding Bottom) tla\u010D\xEDtka", defaultValue: 14 },
                  { type: "number", name: "pl", label: "Vnit\u0159n\xED lev\xFD prostor (Padding Left) tla\u010D\xEDtka", defaultValue: 28 },
                  { type: "number", name: "pr", label: "Vnit\u0159n\xED prav\xFD prostor (Padding Right) tla\u010D\xEDtka", defaultValue: 28 },
              ...
              // 6. OBRÁZEK
              {
                ...
                fields: [
                  ...
                  { type: "number", name: "borderRadius", label: "Zaoblen\xED roh\u016F (px)", defaultValue: 0 }
                ]
              }
            ]
          }
